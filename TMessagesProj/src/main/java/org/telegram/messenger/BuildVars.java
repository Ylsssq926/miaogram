...
public class BuildVars {
    ...
    // MIAOGRAM: API credentials injected from .private/api-keys.properties at
    // build time (see TMessagesProj/build.gradle getMiaoAppId/getMiaoAppHash).
    // Falls back to the upstream default when no private credentials are set.
    public static int APP_ID = BuildConfig.MIAO_APP_ID;
    public static String APP_HASH = BuildConfig.MIAO_APP_HASH;
