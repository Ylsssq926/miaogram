...
//        }
    ...
    public boolean canForwardMessage() {
        ...
        boolean miaoNoforwards = messageOwner.noforwards && !com.miaogram.miao.feature.RestrictionBypass.isEnabled(); // MIAOGRAM_HOOK: bypass noforwards
        return !(messageOwner instanceof TLRPC.TL_message_secret) && !needDrawBluredPreview() && !isLiveLocation() && type != MessageObject.TYPE_PHONE_CALL && !isSponsored() && !miaoNoforwards;
    }
