...
如果你是来测试的：欢迎，记得带日志。建议从 [`docs/testing-checklist.md`](https://github.com/Ylsssq926/miaogram/blob/main/docs/testing-checklist.md) 开始，这样反馈更容易复现。
...
If you are here to test: welcome, and please bring logs. Start with [`docs/testing-checklist.md`](https://github.com/Ylsssq926/miaogram/blob/main/docs/testing-checklist.md) so feedback is easier to reproduce.
